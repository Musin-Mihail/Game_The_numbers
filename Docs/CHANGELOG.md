...
- Спрайты: Flux.1 Dev через ComfyUI API (`python Tools/comfyui/download_models.py` затем `generate.py`). Python-геометрия — fallback.
...
- Промпты ComfyUI: `Docs/COMFYUI_PROMPTS.md`.
